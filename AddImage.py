...
pygame.display.set_caption("Image Display") # Set window title
...
while is_running :
    ...
    # Fill background with white color (optional, background image will cover)
    game_window.fill((255, 255, 255))
    # Blit images onto the window
    game_window.blit(background_image, (0, 0))
    game_window.blit(balloon_red_image, (200, 300)) # Blit balloon at a specific position
